...
你嘅任務係抽取以下資料，同時根據批號推算生產日期。Return PURE JSON（唔好有任何其他文字、markdown、code fence）：

{
  ...
  "production_date_reasoning": "根據P&G批號格式，YYWW代表年份同週數，52=2025年，75=第75週...",
  "confidence": {
    "name": "high",
    "brand": "high",
    "pao_months": "medium",
...
- production_date如果推算唔到就填null
- production_date_confidence: "high"=幾乎確定, "medium"=合理推算, "low"=唔確定, "none"=完全唔知
- production_date_reasoning用繁體中文解釋點解咁推算
